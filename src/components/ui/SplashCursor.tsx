...
function SplashCursor({
    ...
    `;
      ...
      `
        ...
        // CUSTOM: Orange Gradient Generation
        function generateColor() {
            // Orange HSV range: ~20 degrees to ~45 degrees.
            // 0.05 (18 deg) to 0.12 (43 deg)
            // Let's vary slightly to get some depth: Orange -> Amber -> Deep Orange
            const minHue = 0.05; // 18 deg
            const maxHue = 0.11; // 40 deg
    ...
    return (
        <div
            style={{
                ...
                width: '100%',
                height: '100%',
                opacity: 0.2 // Adjust opacity here (0.0 to 1.0)
            }}
        >
            <canvas
                ref={canvasRef}
